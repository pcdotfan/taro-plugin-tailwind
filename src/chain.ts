...
import { HIDDEN_CONFIG_PATH, CURRENT_PLATFORM, SUPPORTED_MINI_PLATFORMS, SUPPORTED_PLATFORMS } from './constant';
      ...
      mini: {
        plugins: [
          ...
          [
            'tailwindcss',
            {
              config: getConfigPath(checkConfigExists(CURRENT_PLATFORM) ? CURRENT_PLATFORM : 'mini'),
            },
          ],
            ...
            use: [
              {
                ...
                options: {
                  postcssOptions: postcssConfig[SUPPORTED_MINI_PLATFORMS.includes(CURRENT_PLATFORM) ? 'mini' : 'h5'],
                },
              },
            ],
          },
